...
namespace SkinInterfaces
{
    ...
    public class DependencyPropertyClassBase
    {
        ...
        public delegate void DependencyPropertyChangedDelegate(object sender, DependencyPropertyChangedEventArgs e);
        public static event DependencyPropertyChangedDelegate DependencyPropertyChanged;
        #endregion
        ...
        public static void PropertyChangedHandler(object sender, DependencyPropertyChangedEventArgs e)
        {
            try
            {
