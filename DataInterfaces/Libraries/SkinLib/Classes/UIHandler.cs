...
namespace SkinLib
{
    ...
    public class UIHandler : PropertyChangedNotificator, IUIHandler
    {
        ...
        {
            get { return UIHandler.instance; }
            protected set { UIHandler.instance = value; }
        }
        ...
        /// <summary>
        /// Gets the main UI Window handle.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the path to the skin folder.
        /// </summary>
        ...
        {
            get { return this.isClosingAllowed; }
            set
            {
                this.isClosingAllowed = value;
                this.RaisePropertyChanged("IsClosingAllowed");
            }
        }

        /// <summary>
        /// Gets or sets if main window should be expanded on multiple screens.
        /// </summary>
        public bool IsMultiScreen
        {
            ...
            set
            {
                ...
                this.RaisePropertyChanged("IsMultiScreen");
            }
        }
        ...
        public bool SetBackground(string imageFileName = null)
        {
            try
            {
                if (String.IsNullOrWhiteSpace(imageFileName) & !String.IsNullOrWhiteSpace(this.CurrentLayout.ImagePath))
                {
                    ...
                    {
                        imageFileName = this.CurrentLayout.ImagePath;
                    }
                }
        ...
        public bool SwapImage(string imageFileName)
        {
            try
            {
        ...
        public bool SwapImage(ImageSource ImageSource)
        {
            try
            {
                DrawingGroup GlobalGroup = new DrawingGroup();
                DrawingGroup FirstGroup = new DrawingGroup();
                DrawingGroup SecondGroup = new DrawingGroup();
                GlobalGroup.Children.Add(FirstGroup);
                GlobalGroup.Children.Add(SecondGroup);
                DrawingImage Image = new DrawingImage { Drawing = GlobalGroup };
                ImageBrush DrwaBrush = new ImageBrush { ImageSource = Image };

                ImageDrawing ExtraPicture = new ImageDrawing { ImageSource = ImageSource };
                ...
                this.CurrentLayout.Background = DrwaBrush;
                GC.Collect();
                return true;
            }
            catch
        ...
        public bool TryLoadImageSource(string fileName, out ImageSource source)
        {
            source = null;
            try
            {
        ...
        /// <summary>
        /// Fits the window to the current working area of the screen.
        /// </summary>
        /// <param name="Expand">Expands the main window to multiple screens</param>
        /// <remarks></remarks>
        public void FitIn()
        {
        ...
        /// <summary>
        /// Attempts to close skins main window.
        /// </summary>
        /// <remarks></remarks>
        public void Close()
        {
        ...
        {
            e.Cancel = !this.IsClosingAllowed;
        }
        ...
        private IntPtr WindowProc(IntPtr hwnd, int msg, System.IntPtr wParam, System.IntPtr lParam, ref bool handled)
        {
            try
            {
                ...
                if (this.MainWindowMessage != null)
                {
                    foreach (WindowMessageDlegeate listener in this.MainWindowMessage.GetInvocationList())
                    {
                        ...
                        {
                            Trace.WriteLine(String.Format("UIHandler:RaiseMainWindowMessage:{0}", ex));
                        }
                    }
                }
                #endregion
                ...
                if (this.IsBackground)
                {
                    if (msg == (int)(WINDOW_MESSAGE.WM_WINDOWPOSCHANGING))
                    {
                        WINDOWPOS newPos = (WINDOWPOS)Marshal.PtrToStructure(lParam, typeof(WINDOWPOS));
                        newPos.hwndInsertAfter = (IntPtr)(HWND.HWND_BOTTOM);
                        Marshal.StructureToPtr(newPos, lParam, true);
                    }
                }
                #endregion
            }
            ...
            {
                Trace.WriteLine(String.Format("UIHandler:WindowProc:{0}", ex.ToString()));
            }
            return hwnd;
        }
